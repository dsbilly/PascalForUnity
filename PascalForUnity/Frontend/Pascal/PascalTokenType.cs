...
public class  PascalTokenType : TokenType
{
    ...
    private static readonly int FIRST_RESERVED_INDEX = AND.ordinal();
    private static readonly int LAST_RESERVED_INDEX  = WITH.ordinal();

    private static readonly int FIRST_SPECIAL_INDEX = PLUS.ordinal();
    private static readonly int LAST_SPECIAL_INDEX  = DOT_DOT.ordinal();
